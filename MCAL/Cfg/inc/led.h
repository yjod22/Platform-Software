...
//#define LED_X_ON(X)             LED_##X##_PORT->BSRRL = LED_##X##_PIN
#define LED_X_ON(X)             GPIO_ResetBits(LED_##X##_PORT,LED_##X##_PIN)
//#define LED_X_ON(X)             GPIO_Write(LED_##X##_PORT,LED_##X##_PIN)
//#define LED_X_OFF(X)            LED_##X##_PORT->BSRRH = LED_##X##_PIN
#define LED_X_OFF(X)             GPIO_SetBits(LED_##X##_PORT,LED_##X##_PIN)
