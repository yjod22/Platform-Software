...
*******************************************************************************
* Version:	   2016b02
* Author/Date: JSO / 2021-10-13
* Change:      Separate local and global functions
*******************************************************************************
* Version:     16.0
 ...
 * */
static int16_t Driver_I2c_Start(I2C_TypeDef* I2Cx, uint8_t address, uint8_t direction, uint8_t ack);
static void Driver_I2c_WriteData(I2C_TypeDef* I2Cx, uint8_t data);
static uint8_t Driver_I2c_ReadAck(I2C_TypeDef* I2Cx);
static uint8_t Driver_I2c_ReadNack(I2C_TypeDef* I2Cx);
static uint8_t Driver_I2c_Stop(I2C_TypeDef* I2Cx);
